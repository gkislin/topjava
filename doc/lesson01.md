...
- Уровень участников у всех разный. Бывают синьоры, бывают начинающие. Не стесняйтесь задавать вопросы, иначе стажировка пройдет впустую! **Глупых вопросов не бывает**.
...
- Если ссылка не открывается, попробуйте [включить VPN](https://github.com/JavaOPs/topjava/wiki/VPN)
----------------------------------------------------
